...
SELECT 
       ItemNumber,  
       SUM(QuantityOnHand*PricePerItem) as RealInventoryValue
FROM  @inventory i 
left join @accounting a on a.ItemNumber = i.ItemNumber
HAVING SUM(i.QuantityOnHand*i.PricePerItem) != a.TotalInventoryValue